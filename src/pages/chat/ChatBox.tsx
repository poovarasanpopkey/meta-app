...
//       setKeyboardHeight(event.keyboardHeight || 300); // fallback if height missing
//     });
...
//   return (
//     <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#e5ddd5', position: 'relative' }}>
//       {/* Header */}
